...
const aws_bots_config = '[{"name":"","alias":"$LATEST","description":"Bot to answer survey.","bot-template":"bot-flowers","commands-help":["I would like to start the survey","I would like to start the survey","Start"],"region":"eu-west-1"}]';
